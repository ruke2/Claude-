...
export const DISTRICTS = {
  ...
  5: {
    city: 'hinoura',
    id: '5', lotSize: 1250, name: '陽ノ浦マリーナ', short: 'マリーナ', kana: 'HINOURA MARINA',
    desc: 'ヨットハーバーを囲んで開かれたリゾート住宅地。別荘とリゾートマンションが並び、夏の人出で商業が持つ。冬は静かになる。',
    landPrice: 1.72,
    farRange: [250, 500],
    rentOffice: 12500,
    rentRetail: 17500,
    ...
    capRate: 0.049,
    station: 0.44,
    fit: { office: 0.20, retail: 0.62, resi: 0.92, rental: 0.70, hotel: 0.96, logi: 0.06, house: 0.58, mixed: 0.60 },
    height: [3, 16],
    usePool: ['resi', 'hotel', 'rental', 'resi', 'retail'],
    hue: 190, elev: 1,
  },
  6: {
    city: 'hinoura',
    id: '6', lotSize: 2150, name: '陽ノ浦臨港地区', short: '臨港', kana: 'HINOURA PORT',
    desc: '外貿コンテナふ頭の後背地。倉庫と加工場が続き、近年は冷蔵・冷凍の需要が伸びている。観光地の裏側を支える街である。',
    landPrice: 0.69,
    farRange: [200, 400],
    rentOffice: 10500,
    rentRetail: 10500,
    ...
    capRate: 0.056,
    station: 0.26,
    fit: { office: 0.20, retail: 0.22, resi: 0.18, rental: 0.34, hotel: 0.22, logi: 1.00, house: 0.14, mixed: 0.24 },
    height: [1, 7],
    usePool: ['logi', 'logi', 'logi', 'office', 'retail'],
    hue: 34, elev: 0,
  },
  ...
  7: {
    city: 'minato',
    id: '7', lotSize: 2450, name: '湊都イーストゲート', short: '東ゲート', kana: 'MINATO EAST GATE',
    desc: '運河の東に造成された新しい業務核。区画がまとまって取れるため、大手各社が次の一等地と見て動いている。街はまだ半分しかできていない。',
    landPrice: 12.31,
    farRange: [600, 1100],
    rentOffice: 32000,
    rentRetail: 26500,
    ...
    capRate: 0.040,
    station: 0.82,
    fit: { office: 0.98, retail: 0.72, resi: 0.62, rental: 0.60, hotel: 0.74, logi: 0.16, house: 0.05, mixed: 1.00 },
    height: [10, 44],
    usePool: ['office', 'mixed', 'office', 'hotel', 'rental'],
    hue: 212, elev: 1,
  },
  8: {
    city: 'minato',
    id: '8', lotSize: 2050, name: '東雲ウォーターフロント', short: '東雲', kana: 'SHINONOME WF',
    desc: '運河沿いに超高層の住棟が連なる新興の住宅地。眺望と共用施設で単価が取れ、分譲の回転が速い。学校と商業の整備が追いついていない。',
    landPrice: 12.13,
    farRange: [450, 900],
    rentOffice: 22000,
    rentRetail: 21500,
    ...
    capRate: 0.042,
    station: 0.70,
    fit: { office: 0.30, retail: 0.62, resi: 1.00, rental: 0.86, hotel: 0.46, logi: 0.10, house: 0.14, mixed: 0.74 },
    height: [8, 46],
    usePool: ['resi', 'resi', 'rental', 'retail', 'mixed'],
    hue: 198, elev: 1,
  },
  ...
  a: {
    city: 'yukino',
    id: 'a', lotSize: 1150, name: '雪野駅前', short: '雪野駅前', kana: 'YUKINO STN',
    desc: '新幹線の停まる北の玄関口。アーケードの商店街が雪をしのいで賑わう。人口は減っているが、郊外の店じまいが続くぶん駅前に人が戻っている。',
    landPrice: 3.37,
    farRange: [450, 800],
    rentOffice: 17500,
    rentRetail: 21000,
    ...
    capRate: 0.05,
    station: 0.88,
    fit: { office: 0.72, retail: 1.00, resi: 0.54, rental: 0.64, hotel: 0.62, logi: 0.08, house: 0.10, mixed: 0.88 },
    height: [4, 18],
    usePool: ['retail', 'mixed', 'office', 'retail', 'hotel'],
    hue: 218, elev: 1,
  },
  b: {
    city: 'yukino',
    id: 'b', lotSize: 1500, name: '雪野中央', short: '雪野中央', kana: 'YUKINO CENTRAL',
    desc: '県の出先機関と地銀の本店が並ぶ街区。支店経済のオフィス需要があるが、雪の重みに耐える建物は工事費がかさむ。',
    landPrice: 1.87,
    farRange: [400, 700],
    rentOffice: 18800,
    rentRetail: 19500,
    ...
    capRate: 0.053,
    station: 0.66,
    fit: { office: 0.74, retail: 0.76, resi: 0.60, rental: 1.00, hotel: 0.48, logi: 0.14, house: 0.22, mixed: 0.70 },
    height: [3, 14],
    usePool: ['rental', 'office', 'rental', 'retail', 'mixed'],
    hue: 232, elev: 1,
  },
  c: {
    city: 'yukino',
    id: 'c', lotSize: 760, name: '雪野北ニュータウン', short: '雪野北', kana: 'YUKINO NORTH',
    desc: '高度成長期に開かれた丘の上の住宅地。車社会で、敷地も家も広い。屋根の雪下ろしが要らない住まいへの建て替え需要がある。',
    landPrice: 0.36,
    farRange: [120, 220],
    rentOffice: 11500,
    rentRetail: 13500,
    ...
    capRate: 0.057,
    station: 0.30,
    fit: { office: 0.10, retail: 0.34, resi: 0.62, rental: 0.56, hotel: 0.10, logi: 0.16, house: 1.00, mixed: 0.28 },
    height: [1, 5],
    usePool: ['house', 'house', 'resi', 'rental', 'retail'],
    hue: 118, elev: 2,
  },
  d: {
    city: 'yukino',
    id: 'd', lotSize: 2600, name: '雪野臨海工業', short: '雪野臨海', kana: 'YUKINO INDUSTRIAL',
    desc: '重化学の工場群と、日本海側の物流を担う倉庫の街。冬でも港は動く。空き工場の跡地がまとまって出ることがある。',
    landPrice: 0.38,
    farRange: [200, 350],
    rentOffice: 10800,
    rentRetail: 10800,
    ...
    capRate: 0.058,
    station: 0.18,
    fit: { office: 0.14, retail: 0.16, resi: 0.12, rental: 0.26, hotel: 0.10, logi: 1.00, house: 0.12, mixed: 0.18 },
    height: [1, 6],
    usePool: ['logi', 'logi', 'logi', 'office'],
    hue: 26, elev: 0,
  },
...
export const CITIES = {
  ...
  yukino: {
    id: 'yukino', name: '雪野市', short: '雪野', buildMul: 1.08,
    // **建設費が高い都市を1つ置くこと。** どの街も同じ工事費だと、
    // 「安い土地に安く建てる」以外の判断が生まれない。
    // 雪国は基礎の深さ・融雪設備・冬期の養生で工事費が1割以上高くつき、
    // そのぶん地価が徹底的に安い、という実際の構図をそのまま持ち込む
    desc: '人口25万の北の工業都市。雪が深く、基礎と融雪設備、冬期の養生で工事費が1割以上高い。そのかわり地価は全都市で最も安く、キャップレートも最も高い。工事は冬に止まるので、工期は長めに見ておくこと。',
  },
};
...
export const MAP_ROWS = [
  ...
  'AAA.AAA.NNN.NNN.SSS.S^S.FF^.FFF.~~~~~~~~PPP.PP^.~~~~DDD.DDD.OOO.555.555.666.666.',
  '================================~~~~~~~~========~~~~D#D.DDD.OOO.5#5.555.666.6#6.',
  'AAA.AAA.N^N.NNN.SSS.SSS.FFF.FFF.~~~~~~~~PPP.PPP.~~~~DDD.DD^.OO#.555.55^.666.666.',
  'AAA.A^A.NNN.NNN.SSS.SSS.F#F.FFF.~~~~~~~~PPP.PPP.~~~~============================',
  'AAA.AAA.NNN.NNN.S#S.SSS.FFF.FF^.~~~~~~~~PP^.PPP.~~~~DDD.DDD.OOO.555.555.666.666.',
  '................................~~~~~~~~........~~~~DDD.D#D.OOO.5^5.555.66^.666.',
  'KKK.KKK.TTT.TTT.JJJ.JJJ.MMM.MMM.~~~~~~~~ZZZ.ZZZ.~~~~DD^.DDD.OOO.555.5#5.666.666.',
  'KKK.KKK.T#T.TTT.JJJ.JJJ.MMM.M#M.~~~~~~~~ZZZ.Z#Z.~~~~............................',
  'KK#.KKK.TTT.TTT.JJJ.JJJ.MMM.MMM.~~~~~~~~ZZZ.ZZZ.~~~~UUU.UUU.OOO.555.555.666.666.',
  '================================~~~~~~~~========~~~~U#U.UUU.O^O.555.555.6#6.666.',
  'KKK.KKK.TTT.TTT.JJJ.J#J.MMM.MMM.~~~~~~~~ZZZ.ZZZ.~~~~UUU.UU^.OOO.55^.555.666.66^.',
  'KKK.KKK.TTT.TT#.JJJ.JJJ.M#M.MMM.~~~~~~~~Z^Z.ZZZ.~~~~============================',
  'KKK.KK^.TTT.TTT.JJJ.JJJ.MMM.MMM.~~~~~~~~ZZZ.ZZZ.~~~~UUU.UUU.XXX.555.555.666.666.',
  '................................~~~~~~~~........~~~~UUU.U#U.XXX.5#5.55^.666.666.',
  'III.III.BBB.BBB.BBB.JJJ.EEE.EEE.~~~~~~~~VVV.VVV.~~~~U^U.UUU.X#X.555.555.666.6#6.',
  'I#I.III.BBB.BBB.BBB.JJJ.EEE.EEE.~~~~~~~~VVV.V#V.~~~~............................',
  'III.III.BBB.BBB.BB#.JJJ~EEE.E#E.~~~~~~~~VVV.VV^.~~~~XXX.XXX.XXX.555.555.666.666.',
  '===========~~~~=======~~========~~~~~~~~========~~~~X#X.XXX.XX^.555.5#5.66^.666.',
  '~II.BBB.BBB~~~~.BBB.~~~~EEE.EEE.~~~~~~~~VVV.VVV.~~~~XXX.XX^.XXX.55^.555.666.666.',
  '~~I.BBB.BB#~~~~.BB~~~~~~EEE.EE^.~~~~~~~~VVV.VVV.~~~~............................',
  '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~',
  '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~',
  '~~~~~~~~~~~~~~~~~~~~~~~~========~~~~~~~~~~~~~~~~~~~~............................',
  'WWW.WWW.WWW.WWW.~~~~~~~~EEE.EEE.~~~~~~~~QQQ.QQQ.~~~~777.777.777.888.888.888.888.',
  'W#W.WWW.WWW.WWW.~~~~~~~~EEE.E#E.~~~~~~~~QQQ.Q#Q.~~~~7#7.777.77^.888.8#8.888.888.',
  'WWW.WWW.WW^.WWW.~~~~~~~~EEE.EEE.~~~~~~~~QQQ.QQQ.~~~~777.777.777.88^.888.888.8#8.',
  '================~~~~~~~~========~~~~~~~~========~~~~============================',
  'WWW.WWW.WWW.WWW.~~~~~~~~EEE.EEE.~~~~~~~~QQQ.QQQ.~~~~777.777.777.888.888.888.888.',
  'WWW.W#W.WWW.W^W.~~~~~~~~E^E.EEE.~~~~~~~~Q^Q.QQQ.~~~~777.7^7.7#7.888.888.88^.888.',
  'WWW.WWW.WWW.WWW.~~~~~~~~EEE.EEE.~~~~~~~~QQQ.QQQ.~~~~777.777.777.888.8#8.888.888.',
  '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~............................',
  '========================================~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~',
  ...
  '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~',
  '~~~~~~~~........................................~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~',
  '~~~~~~~~aaa.aaa.aaa.bbb.bbb.ccc.ccc.ccc.ddd.ddd.~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~',
  '~~~~~~~~a#a.aaa.aaa.b#b.bbb.ccc.c#c.ccc.ddd.d#d.~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~',
  '~~~~~~~~aaa.aa^.aaa.bbb.bb^.cc^.ccc.ccc.dd^.ddd.~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~',
  '~~~~~~~~========================================~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~',
  '~~~~~~~~aaa.aaa.aaa.bbb.bbb.ccc.ccc.ccc.ddd.ddd.~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~',
  '~~~~~~~~aaa.a#a.aa^.bbb.b#b.ccc.ccc.c^c.ddd.ddd.~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~',
  '~~~~~~~~aaa.aaa.aaa.bb^.bbb.ccc.c#c.ccc.ddd.dd^.~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~',
  '~~~~~~~~........................................~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~',
  '~~~~~~~~aaa.aaa.aaa.bbb.bbb.ccc.ccc.ccc.ddd.ddd.~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~',
  '~~~~~~~~a^a.aaa.a#a.bbb.bb^.c#c.ccc.ccc.d#d.ddd.~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~',
  '~~~~~~~~aaa.aaa.aaa.bbb.bbb.ccc.cc^.ccc.ddd.ddd.~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~',
  '~~~~~~~~........................................~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~',
  '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~',
  '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~',
  '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~',
