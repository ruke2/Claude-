...
window.GAME = (function () {
  ...
  /* 階級別の基準年収（万円・給与水準「標準」かつ創業規模のとき） */
  D.ROLE_SALARY = [1050, 1650, 2400, 3600, 6000];
  /* 一般社員（総合職）の基準平均年収（万円） */
  D.BASE_SALARY = 900;

  /* 給与水準。全社の人件費・士気・定着・採用力を一括で動かす */
  D.PAY_BANDS = [
    { n: '業界最低水準', k: 0.74, morale: -14, retain: -0.35, hire: -0.22,
      desc: '人件費は最も軽い。ただし優秀な人間から順に辞めていく' },
    { n: '低め',        k: 0.87, morale: -6,  retain: -0.16, hire: -0.10, desc: 'コストを抑えるが、採用でも競り負けやすい' },
    { n: '標準',        k: 1.00, morale: 0,   retain: 0,     hire: 0,     desc: '同業他社と横並び' },
    { n: '高め',        k: 1.22, morale: +7,  retain: +0.18, hire: +0.10, desc: '定着と採用に効く。人件費は2割増' },
    { n: '業界最高水準', k: 1.58, morale: +15, retain: +0.36, hire: +0.22,
      desc: '人が集まり、辞めない。ただし固定費が重くのしかかる' },
  ];

  /* 新卒採用の方針 */
  D.GRAD_POLICIES = [
    { id: 'mass', name: '量重視', icon: '👥', size: 2.1, cost: 0.70, q: 0.86, ratio: 0.42,
      good: '頭数が揃い、現場の処理能力が上がる', bad: '幹部候補は出にくく、能力も平均的' },
    { id: 'balanced', name: 'バランス', icon: '⚖️', size: 1.0, cost: 1.0, q: 1.0, ratio: 1.0,
      good: '量と質のどちらにも寄せない', bad: '尖った人材は出にくい' },
    { id: 'elite', name: '質重視', icon: '🎓', size: 0.5, cost: 2.1, q: 1.22, ratio: 3.4,
      good: '少数精鋭。幹部候補が育ちやすく、能力も高い', bad: '一人あたりのコストが2倍、頭数は増えない' },
    { id: 'global', name: 'グローバル採用', icon: '🌏', size: 0.8, cost: 1.5, q: 1.12, ratio: 1.7,
      global: true, good: '海外拠点で現地採用。駐在適性が高く、地域特性を持つ幹部が育つ',
      bad: '拠点がなければ意味がなく、コストも高い' },
  ];

  /* 決算で見せる年次サマリーの並び */
  D.PL_ROWS = [
    { k: 'gtv', name: '取扱高', hint: 'トレードの取扱総額・請負金額・傘下事業会社の年商' },
    { k: 'revenue', name: '収益（売上高）', hint: '口銭・請負・配当・評価益の合計' },
    { k: 'cost', name: '費用', hint: '工事原価・人件費・販管費・支払利息・減損' },
    { k: 'profit', name: '当期純利益', hint: '' },
  ];
